...
sed -i 's+jetbrains.mps.Launcher+-Dorg.jetbrains.projector.server.classToLaunch=jetbrains.mps.Launcher org.jetbrains.projector.server.ProjectorLauncher+g' "$IDE_RUN_FILE_NAME-projector.sh"
